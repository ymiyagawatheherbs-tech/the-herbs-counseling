...
// ── お薬・サプリメントの種類（Section 4） ─────────────────────────────────────
// ハーブ・精油と相互作用（拮抗＝効きを弱める／助長＝効きを強める）の可能性が
// 知られているお薬の分類。
//
// ⚠ 重要な設計方針
//   - このチェックは「使用の可否を判定するもの」ではありません。
//     該当した場合に「医師・薬剤師にご確認ください」と注意喚起するためのものです。
//   - サーバーには送信しません（要配慮個人情報のため、端末内での表示のみに使用）。
//   - 最終的な判断は必ず医療専門職に委ねます。
// ─────────────────────────────────────────────────────────────────

export interface MedicationCategory {
  label: string;       // お客様に見せる分類名（薬効名は平易に）
  note: string;        // 該当時にサロン・お客様へ出す注意文
}

export const MEDICATION_CATEGORIES: MedicationCategory[] = [
  {
    label: "血液をサラサラにするお薬",
    note: "一部のハーブ（イチョウ葉・ニンニクなど）は、このお薬の働きに影響することが知られています。ハーブティーやサプリメントをお使いの前に、医師・薬剤師にご確認ください。",
  },
  {
    label: "血圧のお薬",
    note: "ローズマリーやリコリス（甘草）など、血圧に関わる可能性があるハーブ・精油があります。ご使用前に医師・薬剤師にご確認ください。",
  },
  {
    label: "睡眠導入剤・抗不安のお薬",
    note: "カモミールやバレリアンなど、リラックス作用のあるハーブは、お薬の働きを強めることがあります。ご使用前に医師・薬剤師にご確認ください。",
  },
  {
    label: "気分に関わるお薬（抗うつ薬など）",
    note: "セントジョーンズワート（セイヨウオトギリソウ）は、多くのお薬と相互作用することが知られています。ご使用前に必ず医師・薬剤師にご確認ください。",
  },
  {
    label: "ホルモンのお薬・低用量ピル",
    note: "セントジョーンズワートなど、お薬の働きに影響する可能性があるハーブがあります。またクラリセージなどホルモン様作用が語られる精油もあります。ご使用前に医師・薬剤師にご確認ください。",
  },
  {
    label: "血糖のお薬",
    note: "血糖に関わる可能性があるハーブがあります。お薬の働きを強めることがあるため、ご使用前に医師・薬剤師にご確認ください。",
  },
  {
    label: "利尿のお薬",
    note: "ジュニパーやリコリス（甘草）など、水分・ミネラルのバランスに関わるハーブがあります。ご使用前に医師・薬剤師にご確認ください。",
  },
  {
    label: "ステロイドのお薬",
    note: "リコリス（甘草）は、このお薬の働きに影響することが知られています。ご使用前に医師・薬剤師にご確認ください。",
  },
  {
    label: "てんかん・けいれんのお薬",
    note: "ローズマリー・フェンネル・セージなど、一部の精油は使用を避けたほうがよいとされています。ご使用前に必ず医師・薬剤師にご確認ください。",
  },
  {
    label: "その他のお薬を服用中",
    note: "ハーブ・精油には、お薬と相互作用するものがあります。ご使用前に医師・薬剤師にご確認ください。",
  },
];

// 妊娠・授乳中の方への注意（該当時に表示）
export const PREGNANCY_NOTE =
  "妊娠中・授乳中は、使用を控えたほうがよいハーブ・精油があります。ご使用前に必ず医師にご確認ください。";
