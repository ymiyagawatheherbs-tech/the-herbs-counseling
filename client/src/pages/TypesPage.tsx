...
const TYPES = [
  {
    ...
    description: "外胚葉型は、神経系・皮膚・感覚器官が発達した繊細な体質です。胃腸が弱く細身で、くすみやすい傾向があります。",
    traits: [
      "細身・太りにくい体型",
      "乾燥肌・敏感肌の傾向",
      "髪が太く、ボリュームが出やすい",
    ...
    carePoint: "頭皮を清潔に保つための、植物性の保湿ケアが効果的です。",
  },
  {
    id: "meso",
    label: "中胚葉型",
    ...
    bd: "#C0D8EC",
    tagline: "バランス・活力・安定",
    description: "中胚葉型は、筋骨格系が発達した体質です。皮脂分泌が多い傾向があり、頭皮のべたつきや毛穴づまりが気になることがあります。",
    traits: [
      "筋肉質・引き締まった体型",
      "混合肌の傾向",
      "髪にハリコシがある",
  ...
  },
  {
    ...
    bd: "#E8C0D0",
    tagline: "豊か・潤い・温かみ",
    description: "内胚葉型は、消化器系・内分泌系が発達した体質です。もともと髪が細く、茶系の髪色、ヘアダメージを受けやすい。",
    traits: [
      "丸みのある体型・太りやすい",
      "乾燥肌、赤みの出やすい肌",
      "髪が細く、ボリュームが出にくい",
